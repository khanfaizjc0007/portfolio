  ...
  return (
    <section ref={containerRef} className="relative min-h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="h-full w-full bg-[radial-gradient(#ffffff08_1px,transparent_1px)] bg-[size:2rem_2rem]" />
      </div>
      ...
      >
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-6">SELECTED WORKSssss</p>
          <h1 className="font-sans text-5xl md:text-7xl lg:text-8xl font-light tracking-tight text-balance mb-8">
            Projects That
            <br />
            <span className="italic">Push Boundaries</span>
          </h1>
          <p className="font-mono text-sm md:text-base text-muted-foreground tracking-wider max-w-2xl mx-auto leading-relaxed">
            A collection of experiments, products, and interfaces that blend design with intelligence.
          </p>
        </motion.div>
      </motion.div>
