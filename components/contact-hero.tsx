  ...
  return (
    <section ref={containerRef} className="relative min-h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="h-full w-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-accent via-transparent to-transparent" />
      </div>

      {/* Content */}
      <motion.div
        style={{ opacity, scale }}
        className="relative z-10 h-full min-h-screen flex flex-col justify-center items-center p-8 md:p-12"
      >
        <motion.div
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-6">GET IN TOUCH</p>
          ...
          <p className="font-mono text-sm md:text-base text-muted-foreground tracking-wider max-w-2xl mx-auto leading-relaxed">
            Available for select freelance projects and collaborations. Let's create something extraordinary.
          </p>
        </motion.div>
      </motion.div>
